                ...
                <div className="pd-ltr-20 xs-pd-20-10">
					...
					<div className="clearfix mb-20">
						<div className="pull-left">
							<h4 className="text-blue h4" style={{color:"blue"}}>Liste des voitures</h4>
							<p>Add class <code>.table</code></p>
						</div>
						<div className="pull-right">
							<a href="#basic-table" className="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button"><i className="fa fa-code"></i> Source Code</a>
						</div>
					</div>
