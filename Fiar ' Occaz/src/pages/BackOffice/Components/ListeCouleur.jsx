                ...
                <div className="pd-ltr-20 xs-pd-20-10">
					...
					<div className="clearfix mb-20">
						<div className="pull-left">
							<h4 className="text-blue h4" style={{color:"blue"}}>Liste des couleurs de voiture</h4>
							<p>Crud <code>.Couleur</code></p>
						</div>
						<div className="pull-right">
							<Link to="/add_couleur" className="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button">+ Ajouter une couleur</Link>
						</div>
					</div>
