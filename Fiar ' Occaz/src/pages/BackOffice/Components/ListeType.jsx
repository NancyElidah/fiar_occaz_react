                ...
                <div className="pd-ltr-20 xs-pd-20-10">
					...
					<div className="clearfix mb-20">
						<div className="pull-left">
							<h4 className="text-blue h4" style={{color:"blue"}}>Liste des Types</h4>
							<p>Crud <code>.Type</code></p>
						</div>
						<div className="pull-right">
							<Link to="/add_type" className="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button">+ Ajouter un nouveau type</Link>
						</div>
					</div>
					<table className="table">
						...
						<tbody>
							<tr>
                                ...
                                <td>
                                    <div>
                                        <Link to="/add_type" className="btn btn-primary btn-sm scroll-click" rel="content-y"  data-toggle="collapse" role="button"><i className="fa fa-edit"></i></Link>
                                    </div>
                                </td>
                                <td>
                                    <div>
