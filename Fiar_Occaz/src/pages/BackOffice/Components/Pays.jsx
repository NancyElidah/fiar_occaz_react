...
class Pays extends Component {
    ...
    addModel = (e) => {
        ...
        console.log(boite);
        PaysService.createPays(token,id,boite).then(() => {
            this.setState({
                message:'insertion reussie'
            })
        });
        this.props.navigation(`/:${sessionStorage.getItem("token")}/gestion_pays`);        // alert("insertion réussie");
                            ...
                            <div className="page-header">
                                <div className="clearfix">
                                    <div className="pull-left">
                                        <h4 className="text-blue h4" style={{color:"blue"}}>Ajout Pays</h4>
                                        <p className="mb-20" style={{fontSize:10}}>Ajouter un Pays</p>
                                    </div>
                                </div>
                        <form>
...
export default WithNavigateHook(Pays);