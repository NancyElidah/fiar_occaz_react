...
class PaysUp extends Component {
    ...
    fetchData = () => {
        ...
        PaysService.getOnePays(token,user,this.state.idboite).then((res) => {
    ...
    addBoite = (e) => {
        ...
        // console.log(user);
        // console.log(boite);
        PaysService.UpdatePays(token, user, this.state.idboite, boite).then(() => {
            this.setState({
                message: 'insertion reussie'
            })
        });
        // console.log(JSON.stringify(boite))
        this.props.navigation(`/:${sessionStorage.getItem("token")}/gestion_pays`);   
    }
                            ...
                            <div className="page-header">
                                <div className="clearfix">
                                    <div className="pull-left">
                                        ...
                                        <p className="mb-20" style={{ fontSize: 10 }}>Modifier un Pays</p>
                                    </div>
                                </div>
                                <form>
                                    <div className="form-group row" style={{ marginLeft: 50 }}>
                                        <label className="col-sm-12 col-md-2 col-form-label" >nom du pays</label>
...
export default withNavigateHook(withRouter(PaysUp));