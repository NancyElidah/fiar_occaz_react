...
class MarqueUp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            message: '',
    ...
    fetchData = () => {
        ...
        MarqueService.getOneMarque(token, user, this.state.idboite).then((res) => {
    ...
    addCouleur = (e) => {
        ...
        // console.log(user);
        // console.log(boite);
        MarqueService.UpdateMarque(token, user, this.state.idboite, boite).then(() => {
            this.setState({
...
export default withNavigateHook(withRouter(MarqueUp));